...
public class JRefreshListView extends ListView implements OnScrollListener {
    ...
    public JRefreshListView(Context context) {
        super(context);
        init();
    }

    public JRefreshListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void initHeaderView() {
        headerView = View.inflate(getContext(), R.layout.view_refresh_header, null);
    ...
    private void initFooterView() {
        footerView = View.inflate(getContext(), R.layout.view_refresh_footer, null);
