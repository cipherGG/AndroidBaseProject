...
public class RetrofitUtils {
     ...
     */
    public RetrofitUtils head(final HashMap<String, String> headers) {
     ...
     * @param log 日志打印开关
     */
    public RetrofitUtils log(HttpLoggingInterceptor.Level log) {
     ...
     */
    public RetrofitUtils factory(Factory factory) {
